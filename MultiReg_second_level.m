...
Cov_names = {'PC1','PC2','IQ_4scale','Sex','Age'};
...
% Left hemisphere
	...
	switch WhichROIs
		...
		case 'DiMartino'
			first_dir = ['/spheres/FirstLevel_',Hemi,'_DiMartino02/'];
	end
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'PC_Score1+';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.convec = [0 0 1 0];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';

matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'PC_Score1-';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.convec = [0 0 -1 0];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';

matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'PC_Score2+';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.convec = [0 0 0 1];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';

matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'PC_Score2-';
